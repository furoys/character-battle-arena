...
export const ENTRY_THEMES: Record<string, ThemeKey[]> = {
  ...
  // ── Expanded matchups ───────────────────────────────────────────────
  "tyson-vs-ali": ["rivals", "street"],
  "bruce-lee-vs-tyson": ["crossover", "street"],
  "bruce-lee-vs-ip-man": ["rivals", "street"],
  "ip-man-vs-tyson": ["crossover", "street"],
  "rocky-vs-tyson": ["rivals", "street"],
  "fury-vs-tyson": ["rivals", "street"],
  "ali-vs-fury": ["rivals", "street"],
  "ryu-vs-ken": ["rivals", "street"],
  "liu-kang-vs-ryu": ["crossover", "street"],
  "liu-kang-vs-johnny": ["rivals", "street"],
  "kitana-vs-mileena": ["rivals", "street", "throwdown"],
  "chun-li-vs-cammy": ["rivals", "street"],
  "akuma-vs-shao-kahn": ["crossover", "street", "throwdown"],
  "goro-vs-sagat-style": ["rivals", "street"],
  "raiden-vs-shao-kahn": ["showdown", "rivals", "street"],
  "daredevil-vs-punisher": ["rivals", "street"],
  "daredevil-vs-batman": ["marvel_vs_dc", "street"],
  "red-hood-vs-punisher": ["marvel_vs_dc", "street"],
  "black-widow-vs-catwoman": ["marvel_vs_dc", "street"],
  "elektra-vs-catwoman": ["marvel_vs_dc", "street"],
  "black-canary-vs-widow": ["marvel_vs_dc", "street"],
  "nightwing-vs-daredevil": ["marvel_vs_dc", "street"],
  "cap-vs-batman": ["marvel_vs_dc", "street"],
  "snake-vs-john-wick": ["crossover", "street"],
  "snake-vs-batman": ["crossover", "street"],
  "lara-vs-ripley": ["rivals", "street"],
  "ripley-vs-sarah": ["rivals", "street"],
  "bond-vs-bourne": ["rivals", "street"],
  "leonidas-vs-wallace": ["rivals", "street"],
  "x-men-vs-brotherhood": ["team", "showdown"],
  "sannin-vs-akatsuki": ["team", "showdown"],
  "z-fighters-vs-akatsuki": ["team", "crossover"],
  "straw-hats-vs-z": ["team", "crossover"],
  "avengers-vs-brotherhood": ["team", "showdown"],
  "marvel-knights-vs-bat-fam": ["team", "marvel_vs_dc", "street"],
  "demons-vs-hashira": ["team", "showdown"],
  "avatar-vs-konoha": ["team", "crossover"],
  "hashira-vs-espada": ["team", "crossover", "throwdown"],
  "bleach-captains-vs-akatsuki": ["team", "crossover"],
  "mha-vs-bleach": ["team", "crossover"],
  "mha-vs-villains": ["team", "showdown"],
  "aot-vs-akatsuki": ["team", "crossover"],
  "fairy-tail-vs-naruto": ["team", "crossover"],
  "sins-vs-akatsuki": ["team", "crossover"],
  "horror-vs-slashers": ["team", "throwdown"],
  "new-gods-vs-asgard": ["team", "marvel_vs_dc", "throwdown"],
  "fantastic-four-vs-titans": ["team", "marvel_vs_dc"],
  "storm-vs-black-lightning": ["marvel_vs_dc"],
  "beast-vs-beast-boy": ["marvel_vs_dc"],
  "cyclops-vs-cyborg": ["marvel_vs_dc"],
  "iron-man-vs-cyborg": ["marvel_vs_dc"],
  "magneto-vs-black-adam": ["marvel_vs_dc", "throwdown"],
  "apocalypse-vs-darkseid": ["marvel_vs_dc", "throwdown"],
  "galactus-vs-anti-mon": ["marvel_vs_dc", "throwdown"],
  "thor-vs-shazam": ["marvel_vs_dc"],
  "loki-vs-joker": ["marvel_vs_dc", "throwdown"],
  "thanos-vs-mongul": ["marvel_vs_dc", "throwdown"],
  "mystique-vs-catwoman": ["marvel_vs_dc"],
  "rogue-vs-raven": ["marvel_vs_dc"],
  "ghost-rider-vs-spectre": ["marvel_vs_dc", "throwdown"],
  "black-bolt-vs-manhattan": ["marvel_vs_dc", "showdown"],
  "silver-surfer-vs-flash": ["marvel_vs_dc"],
  "sabretooth-vs-deathstroke": ["marvel_vs_dc", "throwdown"],
  "colossus-vs-doomsday": ["marvel_vs_dc", "showdown"],
  "hela-vs-trigon": ["marvel_vs_dc", "throwdown"],
  "joker-vs-sukuna": ["throwdown", "crossover"],
  "joker-vs-carnage": ["throwdown", "marvel_vs_dc"],
  "pennywise-vs-voldemort": ["throwdown", "crossover"],
  "aizen-vs-madara": ["throwdown", "rivals"],
  "all-for-one-vs-shigaraki": ["throwdown", "rivals"],
  "apocalypse-vs-doomsday": ["throwdown", "marvel_vs_dc"],
  "knull-vs-carnage": ["throwdown", "rivals"],
  "pinhead-vs-hannibal": ["throwdown", "crossover"],
  "t1000-vs-predator": ["throwdown", "crossover"],
  "bellatrix-vs-azula": ["throwdown", "crossover"],
  "vegeta-vs-vader": ["crossover"],
  "itachi-vs-loki": ["crossover"],
  "sasuke-vs-sephiroth": ["crossover"],
  "madara-vs-sauron": ["crossover", "throwdown"],
  "ichigo-vs-kratos": ["crossover"],
  "vader-vs-voldemort": ["crossover", "throwdown"],
  "vader-vs-sauron": ["crossover", "throwdown"],
  "aizen-vs-voldemort": ["crossover", "throwdown"],
  "doom-slayer-vs-hulk": ["crossover"],
  "doom-slayer-vs-doomsday": ["crossover", "throwdown"],
  "naruto-vs-ichigo": ["crossover"],
  "goku-vs-broly-final": ["rivals"],
  "naruto-vs-pain": ["rivals"],
  "madara-vs-hashirama": ["rivals", "showdown"],
  "aizen-vs-ichigo": ["rivals", "showdown"],
  "eren-vs-levi": ["rivals", "showdown"],
  "mikasa-vs-annie": ["rivals"],
  "tanjiro-vs-muzan": ["rivals", "showdown"],
  "rengoku-vs-akuma-sf": ["crossover"],
  "erza-vs-mikasa": ["rivals"],
