...
const MATCHUPS: Matchup[] = [
  ...
  },
  {
    ...
    title: "The Flash vs Quicksilver",
    theory: "The original DC vs Marvel speedster debate. Barry Allen taps the Speed Force and has outrun death itself. Pietro Maximoff is the fastest mutant alive and a founding Avenger. Most scalers give it to Flash on raw top-speed — but Quicksilver fans point to his reaction time and combat experience. The cleanest speed argument in comics.",
    team1Ids: [789],
    team2Ids: [701],
    mode: "debate",
    category: "Legacy vs Multiverse",
  ...
  },
  {
    ...
    theory: "Luffy + Goku vs Naruto + Ichigo — the biggest shonen debate ever. Power scaling puts Goku miles ahead and Ichigo's Bankai close behind. But Luffy's Conqueror's Haki can knock out weaker-willed opponents instantly, and Naruto's Six Paths Sage Mode is planet-level. The fun here isn't the answer — it's the argument.",
    team1Ids: [57, 2],
    team2Ids: [6, 83],
    mode: "fun",
    category: "Anime Debates",
  ...
  },
  {
    ...
    theory: "The top of Dragon Ball vs itself. Goku + Vegeta + Gogeta vs Jiren + Beerus + Broly. This is a power scaling nightmare even within the same franchise. Beerus alone might end all of them — but Gogeta Blue vs Broly is the fight fans actually want.",
    team1Ids: [2, 12, 575],
    team2Ids: [41, 40, 42],
    mode: "fun",
    category: "Anime Debates",
  ...
  },
  {
    ...
    theory: "Bond is suave and gadget-reliant. Hunt has done things that shouldn't be physically possible. Bourne is a human weapon with amnesia. Wick doesn't stop. Fan consensus: Bourne in a straight fight, Hunt on a mission, Bond in a tuxedo, Wick in a hallway.",
    team1Ids: [111, 110],
    team2Ids: [118, 100],
    mode: "fun",
    category: "Street Level",
  ...
  },
  {
    ...
    theory: "Darth Vader + Palpatine + Darth Maul vs Luke Skywalker + Yoda + Obi-Wan Kenobi. The Sith team has raw power and no mercy. The Jedi team has wisdom and the Force of balance behind them. Legends-era Luke matches Palpatine in the Force. But Palpatine + Vader together... that's different.",
    team1Ids: [9, 48, 605],
    team2Ids: [45, 46, 47],
    mode: "debate",
    category: "Sci-Fi Clash",
